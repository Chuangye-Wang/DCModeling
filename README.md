...
$$D^*_A = \exp\!\left(x_A \ln D_{AA} + x_B \ln D_{AB} + \frac{\Phi_A \, x_A \, x_B}{RT}\right)$$

$$D^*_B = \exp\!\left(x_A \ln D_{BA} + x_B \ln D_{BB} + \frac{\Phi_B \, x_A \, x_B}{RT}\right)$$
...
## Thermodynamic factor calculation results
